          ...
          <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-10">
            ...
            <div className="order-3 space-y-6 lg:col-start-1 lg:row-start-2">
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                <LoadingSkeleton className="h-56 rounded-[28px] border border-border bg-card/80" />
                <LoadingSkeleton className="h-56 rounded-[28px] border border-border bg-card/80" />
              </div>
              <LoadingSkeleton className="h-72 rounded-[28px] border border-border bg-card/80" />
            </div>
