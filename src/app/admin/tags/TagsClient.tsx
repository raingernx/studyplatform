  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        <StatCard
          label="Unused Tags"
          value={tags.filter((t) => t._count.resources === 0).length.toLocaleString()}
          color="zinc"
        />
      </div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-lg bg-violet-600
                                         px-3 py-1.5 text-[12px] font-medium text-white shadow-sm
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-lg border
                                         border-zinc-200 bg-white px-3 py-1.5 text-[12px]
                                         font-medium text-zinc-500 shadow-sm transition
                          ...
                          <div className="flex flex-col items-end gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="inline-flex items-center gap-1 rounded-lg bg-red-600
                                           px-3 py-1.5 text-[12px] font-medium text-white shadow-sm
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 rounded-lg border
                                         border-zinc-200 bg-white px-3 py-1.5 text-[12px]
                                         font-medium text-zinc-600 shadow-sm transition
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 rounded-lg border
                                         border-zinc-200 bg-white px-3 py-1.5 text-[12px]
                                         font-medium text-red-500 shadow-sm transition
