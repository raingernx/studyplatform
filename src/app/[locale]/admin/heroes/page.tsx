      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-meta text-text-secondary">
            Marketing hero campaigns for the marketplace homepage.
          </p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1100px] text-left text-sm">
              <thead className="border-b border-border-subtle bg-surface-50/70">
                <tr>
                  <th className="px-5 py-2.5 text-meta font-medium text-text-muted">Name</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Type</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Priority</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Weight</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Schedule</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">A/B group</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Status</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Impressions</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Clicks</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">CTR</th>
                  <th className="px-3 py-2.5 text-meta font-medium text-text-muted">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border-subtle/60">
                {heroes.map((hero) => (
                  <tr key={hero.id} className="bg-white/80">
                    <td className="px-5 py-3 font-medium text-text-primary">{hero.name}</td>
