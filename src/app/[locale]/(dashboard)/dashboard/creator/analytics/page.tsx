...
import { BarChart2, DollarSign, Download, FileText, ShoppingBag } from "lucide-react";
import { authOptions } from "@/lib/auth";
import { formatDate, formatPrice } from "@/lib/format";
import { routes } from "@/lib/routes";
import { getCreatorAccessState, getCreatorAnalytics } from "@/services/creator.service";

export const metadata = {
  title: "Creator Analytics – PaperDock",
};
...
export default async function CreatorAnalyticsPage({
  ...
  const analytics = await getCreatorAnalytics(session.user.id, range);
